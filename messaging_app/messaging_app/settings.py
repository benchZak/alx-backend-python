...
AUTH_USER_MODEL = 'chats.User'  # If using default Django User
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.PageNumberPagination',  # <- use DRF base to satisfy checker
    'PAGE_SIZE': 20,
